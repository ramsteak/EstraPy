...
def parse_command(command: list[Token | Tree[Token]], parsecontext: ParseContext) -> Command[CommandArguments, CommandResult]:
    ...
    parsecontext.commands.append(cmd)
    return cmd
